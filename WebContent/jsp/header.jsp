			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav" id="catUL">
						...
						<%-- 						
						<li class="active">
							<a href="${pageContext.request.contextPath}/jsp/product_list.jsp">
								手机数码
...
<script type="text/javascript">
	$(function() {
		//向服务器CategoryServlet用getAllCats发起ajax请求
		//服务端经过处理，将分类信息以json格式返回，然后把信息绑定到页面的显示分类区域
		var url = "/StoreV5/CategoryServlet";
		var obj = {
			"method" : "findAllCats"
		};
		$.post(url, obj, function(data) {
			$.each(data, function(i, obj) {
				var li = "<li><a href='/StoreV5/ProductServlet?method=findProductsByCidWithPage&num=1&cid=" + obj.cid + "'>" + obj.cname + "</a></li>";
				$("#catUL").append(li);
			});
		}, "json");
	});
